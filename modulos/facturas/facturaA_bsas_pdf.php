...
{$this->fpdf();
 ...
 $this->yoffset=-45;//desplazado hacia arriba
}

function nombre($string)  {
    $this->SetFont('Arial','B',8);
    $this->setxy(39+$this->xoffset,86+$this->yoffset);
...
function direccion($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(39+$this->xoffset,91+$this->yoffset);
    $string=substr($string,0,75);
    $this->cell(0,0,$string);
}
...
function cuit($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(39+$this->xoffset,96+$this->yoffset);
    $this->cell(0,0,$string);
}

function iva($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(39+$this->xoffset,101+$this->yoffset);
    $this->cell(0,0,$string);
}
...
function fecha($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(159+$this->xoffset,86+$this->yoffset);
    $this->cell(53,0,$string,null,null,'L'); //5.3cm de ancho, alineacion derecha
}
function pedido($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(159+$this->xoffset,91+$this->yoffset);
    $this->cell(53,0,$string,null,null,'L'); //5.3cm de ancho, alineacion derecha
}

function remito($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(159+$this->xoffset,96+$this->yoffset);
    $this->cell(53,0,$string,null,null,'L'); //5.3cm de ancho, alineacion derecha
}
...
function venta($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(159+$this->xoffset,101+$this->yoffset);
    $this->cell(53,0,$string,null,null,'L'); //5.3cm de ancho, alineacion derecha
}
...
function descripcion($string)
{
	...
	$cantidad=count($array_string);
		...
		{
		   $this->setxy(39+$this->xoffset,$this->desp_producto+$this->yoffset);
...
{
 $this->SetFont('Arial','B',8);
 $this->setxy(161+$this->xoffset,$this->desp_producto_aux+$this->yoffset);
...
{
 $this->SetFont('Arial','B',8);
 $this->setxy(190+$this->xoffset,$this->desp_producto_aux+$this->yoffset);
 $this->cell(2,0,$moneda,null,null,'L'); //2.5cm de ancho, alineacion derecha
...
{$this->SetFont('Arial','B',8);
 $this->setxy(188+$this->xoffset,279+$this->yoffset);//+3.2cm //+3mm en y
 $this->cell(2,0,$moneda,null,null,'L'); //2.5cm de ancho, alineacion derecha
 $this->setxy(188+$this->xoffset,279+$this->yoffset);//+3.2cm //+3mm en y
...
{$this->SetFont('Arial','B',8);
 $this->setxy(188+$this->xoffset,285+$this->yoffset);//+3.2cm //+3mm en y
 $this->cell(2,0,$moneda,null,null,'L'); //2.5cm de ancho, alineacion derecha
 $this->setxy(188+$this->xoffset,285+$this->yoffset);//+3.2cm //+3mm en y
 $this->cell(25,0,$string,null,null,'R'); //2.5cm de ancho, alineacion derecha
}
...
{$this->SetFont('Arial','B',8);
 $this->setxy(188+$this->xoffset,291+$this->yoffset);//+3.2cm //+3mm en y
 $this->cell(2,0,$moneda,null,null,'L'); //2.5cm de ancho, alineacion derecha
 $this->setxy(188+$this->xoffset,291+$this->yoffset);//+3.2cm //+3mm en y
 $this->cell(25,0,$string,null,null,'R'); //2.5cm de ancho, alineacion derecha
}
