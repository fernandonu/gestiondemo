...
// $this->desp_producto=105;
 $this->desp_producto=115;
 $this->xoffset=-2;//(-izq +der)
 $this->yoffset=-31;//desplazado hacia arriba
}

function nombre($string)  {
    $this->SetFont('Arial','B',8);
    $this->setxy(32+$this->xoffset,77+$this->yoffset);
...
function direccion($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(32+$this->xoffset,82+$this->yoffset);
    $string=substr($string,0,75);
    $this->cell(0,0,$string);
}
...
function cuit($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(32+$this->xoffset,87+$this->yoffset);
    $this->cell(0,0,$string);
}
...
function iva($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(32+$this->xoffset,92+$this->yoffset);
    $this->cell(0,0,$string);
}
...
function fecha($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(145+$this->xoffset,77+$this->yoffset);
    $this->cell(53,0,$string,null,null,'L'); //5.3cm de ancho, alineacion derecha
}

function pedido($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(145+$this->xoffset,82+$this->yoffset);
    $this->cell(53,0,$string,null,null,'L'); //5.3cm de ancho, alineacion derecha
}
function remito($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(145+$this->xoffset,87+$this->yoffset);
    $this->cell(53,0,$string,null,null,'L'); //5.3cm de ancho, alineacion derecha
}
...
function venta($string) {
    $this->SetFont('Arial','B',8);
    $this->setxy(145+$this->xoffset,92+$this->yoffset);
    $this->cell(53,0,$string,null,null,'L'); //5.3cm de ancho, alineacion derecha
}
...
function descripcion($string)
{
	...
	$cantidad=count($array_string);
		...
		{
		   $this->setxy(32+$this->xoffset,$this->desp_producto+$this->yoffset);
...
{
 $this->SetFont('Arial','B',8);
 $this->setxy(149+$this->xoffset,$this->desp_producto_aux+$this->yoffset);
...
{$this->SetFont('Arial','B',8);
 ...
 $this->setxy(180+$this->xoffset,278+$this->yoffset);//+3.2cm //+3mm en y
 $this->cell(2,0,$moneda,null,null,'L'); //2.5cm de ancho, alineacion derecha
 $this->setxy(180+$this->xoffset,278+$this->yoffset);//+3.2cm //+3mm en y
 $this->cell(25,0,$string,null,null,'R'); //2.5cm de ancho, alineacion derecha
