...
//}
 ...
 {if($caja_cerrada) {
   ...
   $link=encode_link("caja_sl.php",array("id_caja"=> $id_caja,"pagina"=>"listado"));
...
<form name="form1" method="post" action="caja_sl.php">
<? 
 ...
 $link_post=encode_link("caja_sl.php",Array('link'=>'poste','fecha'=>$fe_post,'moneda'=>$moneda));	 
 $link_ant=encode_link("caja_sl.php",Array('link'=>'ant','fecha'=>$fe_ant,'moneda'=>$moneda));  
