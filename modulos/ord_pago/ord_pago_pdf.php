...
include_once("ord_pago_clasepdf.php"); 
...
*/
$query="select id_licitacion,l.user_login as usuario,l.fecha,o.fecha_entrega,o.lugar_entrega,o.cliente,plantilla_pagos.descripcion,moneda.*,razon_social,contactos.nombre as contacto ".
...
//   $mail=false; 
 //else $mail=true;
   $pdf->guardar_servidor("orden_de_pago_$nro_orden.pdf");
