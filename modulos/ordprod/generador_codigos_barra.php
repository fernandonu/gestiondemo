...
function generar_cb($barcode='0123456789',$output='png',$width='460',$height='120',$xres='2',$font='5',$border='off',$drawtext='off',$stretchtext=' ',$negative='off',$redimweight='',$redimheight='')
{
global $html_root;
...
if (isset($barcode) && strlen($barcode)>0) {
  ...
  $obj = new C128AObject(200, 100, $style, $barcode);
...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Author>Gestión</o:Author>
  <o:LastAuthor>Gestión</o:LastAuthor>
  ...
  <o:Company>CORADIR S.A.</o:Company>
  <o:Lines>9</o:Lines>
...
while ($index<$cant_generar)
{

$cb_generar=$_POST["cod_barra_$index"];
$numeros_serie[sizeof($numeros_serie)]=$cb_generar;
if (($fila==1) && ($columna==1))
{//nueva tabla
	//$buffer.="$index";
   ...
   <tr style=3D'mso-yfti-irow:0;mso-yfti-firstrow:yes;page-break-inside:avoid'>
    ...
    <table class=3DMsoTableGrid border=3D0 cellspacing=3D0 cellpadding=3D0
     ...
     <tr style=3D'mso-yfti-irow:0;mso-yfti-firstrow:yes'>
      ...
      lang=3DES-AR style=3D'font-size:12.0pt;mso-ansi-language:ES-AR;mso-fareast-language:
      ES-AR'>$cb_generar</span></b><span style=3D'font-size:9.0pt'><o:p></o:p></span></p>
      </td>
     </tr>
     <tr style=3D'mso-yfti-irow:1'>
      <td width=3D176 valign=3Dtop style=3D'width:148.05pt;padding:0cm 5.4pt 0cm 5.4pt;'>
      <p class=3DMsoNormal><o:p><b><span style=3D'font-size:12.0pt;'>$titulo_producto</span></b></o:p></p>
      </td>
     </tr>
	 ...
	 <tr style=3D'mso-yfti-irow:5'>
      ...
      lang=3DES-AR style=3D'mso-ansi-language:ES-AR;mso-fareast-language:ES-AR'><!--[if gte vml 1]><v:shape
       id=3D\"_x0000_i1031\" type=3D\"#_x0000_t75\" style=3D'width:140pt;height:50pt'>
       <v:imagedata src=3D\"word2003-mejorULTIMA_archivos/$cb_generar.png\" o:title=3D\"CDR%20Computers%20black\"/>
      </v:shape><![endif]--><![if !vml]><img style=3D'width:140pt;height:50pt'
      src=3D\"word2003-mejorULTIMA_archivos/$cb_generar.png\" v:shapes=3D\"_x0000_i1031\"><![endif]></span></p>
      </td>
     </tr>
    </table>
    </div>
...
}//de while ($index<$et_x_boton && $cant_total<$cantidad_maq)
...
}//de while(((($fila*3)-(3-$columna))<=9) && !($fila==1 && $columna==1))
...
".chunk_split(base64_encode(generar_cb($serie,'png',200,90,1,'','off','off','on','off')));
}
$buffer.="
