...
<form name='form1' action="subir_archivo_ord_compra.php" method="POST" enctype="multipart/form-data">
...
<input type="hidden" name="es_stock_subir" value="<?=$es_stock_subir?>">
<input type="hidden" name="mostrar_dolar_subir" value="<?=$mostrar_dolar_subir?>">
<input type="hidden" name="tipo_lic_subir" value="<?=$tipo_lic_subir?>">

<table align="center">
 <tr>
  <td><input name="guardar" type="submit" value="Guardar"></td>
  <td><input name="volver" type="button" value="Volver" onclick="location.href='<?= encode_link("ord_compra_recepcion.php",array("nro_orden"=>$nro_orden,"es_stock"=>$es_stock_subir,"mostrar_dolar"=>$mostrar_dolar_subir,"tipo_lic"=>$tipo_lic_subir)) ?>'; window.close();"></td>
 </tr>
</table>
