...
?>
      <tr  bgcolor='<?php echo $color; ?>' onMouseOver="sobre(this,'#FFFFFF');" onMouseOut="bajo(this,'<? echo $color?>' );"><a href="<? echo encode_link("detalle_noconformes.php", array("pagina"=>"listado","id" =>$resultado->fields["id_noconforme"])); ?>" >
      <td align="center">
  ...
  <div align="center">
    <table>
      <tr>
        <td><input type="button" name="boton" value='Agregar Nuevo' onclick="document.location='detalle_noconformes.php'">
        </td>
        <td>
