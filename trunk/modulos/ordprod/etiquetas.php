...
<![endif]-->
<title>YR10ONMAI108</title>
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Author>Diego Ingaramo</o:Author>
  <o:LastAuthor>Diego Ingaramo</o:LastAuthor>
  <o:Revision>3</o:Revision>
  <o:TotalTime>73</o:TotalTime>
  <o:Created>2004-12-01T22:32:00Z</o:Created>
  <o:LastSaved>2004-12-02T12:25:00Z</o:LastSaved>
  <o:Pages>1</o:Pages>
  <o:Words>203</o:Words>
  <o:Characters>1120</o:Characters>
  <o:Company>CORADIR</o:Company>
  <o:Lines>9</o:Lines>
...
//Actualizo titulo y descripcion de etiqueta
$sql="update orden_de_produccion set descripcion_etiqueta='".$_GET['descripcion_etiqueta']."',titulo_etiqueta='".$_GET['titulo_etiqueta']."' where nro_orden=".$parametros['nro_orden'];
$db->Execute($sql) or die ($db->ErrorMsg()."<br>".$sql);

//traigo de BD maquinas a imprimir etiquetas
$sql="select orden_de_produccion.cantidad,renglon.codigo_renglon,nserie_desde,renglon.id_licitacion from orden_de_produccion left join renglon using(id_renglon) where orden_de_produccion.nro_orden=".$parametros['nro_orden'];
$resultado_maquinas=$db->Execute($sql) or die ($db->ErrorMsg()."<br>".$sql);

$et_x_boton=306;//numero de etiquetas por boton 306 si se cambia esta constante cambiarla en la pagina ordenes_nueva.php
$num=$_GET['num'];
$cantidad_maq=$resultado_maquinas->fields['cantidad'];

//seteamos variables
$fila=1;
$columna=1;

$resultado_maquinas->fields['titulo_etiqueta']=$_GET['titulo_etiqueta'];
$resultado_maquinas->fields['descripcion_etiqueta']=$_GET['descripcion_etiqueta'];

$resto_numero=substr($resultado_maquinas->fields['nserie_desde'],0,6);
$letra1=substr($resultado_maquinas->fields['nserie_desde'],6,1);
$letra2=substr($resultado_maquinas->fields['nserie_desde'],7,1);
$letra3=substr($resultado_maquinas->fields['nserie_desde'],8,1);
$letra=$letra1.$letra2.$letra3;
$nro=intval(substr($resultado_maquinas->fields['nserie_desde'],-3));

//calcula el numero con el cual se comenzar a generar
//la etiquetas considerando que se generaron 306 etiquetas
//por cada boton
$cant_maq=$num*$et_x_boton;  //cantidad de etiquetas generadas para los botones anteriores 
$control=$nro+$cant_maq;
$nro=($nro+$cant_maq)%1000;  //ultimo numero que se genera con el boton presionado
...
$cantidad_impresa=0;
$cant_total=$num*$et_x_boton;

//inserto etiqueta por maquina
while ($cantidad_impresa<$et_x_boton && $cant_total<$cantidad_maq)
{
$serialp='';
if ($nro<100) //concateno valor con los 0 que pueden llegar a faltar
	$serialp.='0';
if ($nro<10)
	$serialp.='0';

	
$serie_armado=$resto_numero.$letra.$serialp.$nro;
$numeros_serie[]=$serie_armado;	
if (($fila==1) && ($columna==1)) {//nueva tabla
	//$buffer.="$cantidad_impresa";
	$buffer.="<table class=3DMsoTableGrid cellspacing=3D0 cellpadding=3D0
            style=3D'margin-left:1.0pt;mso-table-layout-alt:fixed;mso-yfti-tbllook:480;
            mso-padding-alt:0cm 0cm 0cm 0cm'>";
}
//fila==1 entonces creo fila nueva
if ($columna==1)
	$buffer.='<tr style=3D\'mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;page-break-inside:avoid\'>';
 
$buffer.="<td width=3D227 valign=3Dtop style=3D'width:6.0cm;height:3.9cm;padding:0cm 0cm 0cm 0cm'>
  <table class=3DMsoTableGrid border=3D0
   style=3D'mso-table-layout-alt:fixed;mso-yfti-tbllook:
   480;padding:0.3cm 0.3cm 0.3cm 0.3cm;mso-padding-alt:0.3cm 0.3cm 0.3cm 0.3cm'>
   <tr style=3D'mso-yfti-irow:0;mso-yfti-firstrow:yes;page-break-inside:avoid'>
    <td width=3D229 valign=3Dtop style=3D'width:172.05pt;padding:0.3cm 0.3cm 0.31cm 0.3cm'>
	<div align=3Dcenter>
    <table class=3DMsoTableGrid border=3D0 cellspacing=3D0 cellpadding=3D0
     ...
     <tr style=3D'mso-yfti-irow:0;mso-yfti-firstrow:yes'>
	  ...
	  <v:shape
       id=3D\"_x0000_i1025\" type=3D\"#_x0000_t75\" alt=3D\"\" style=3D'width:15.75pt;
	   height:89.25pt'>
       <v:imagedata src=3D\"word2003-mejorULTIMA_archivos/image003.gif\" o:title=3D\"image004\"/>
      </v:shape><![endif]--><![if !vml]><img width=3D21 height=3D119
      src=3D\"word2003-mejorULTIMA_archivos/image004.gif\" v:shapes=3D\"_x0000_i1025\"><![endif]></span></p>
      </td>
      <td width=3D235 valign=3Dtop style=3D'width:148.05pt;padding:0cm 5.4pt 0cm 5.4pt'>
      <p class=3DMsoNormal><em><span lang=3DES-AR style=3D'font-size:9.0pt;
      mso-ansi-language:ES-AR;mso-fareast-language:ES-AR'>N de Serie: </span></em><b><span
      lang=3DES-AR style=3D'font-size:9.0pt;mso-ansi-language:ES-AR;mso-fareast-language:
      ES-AR'>$serie_armado</span></b><span style=3D'font-size:9.0pt'><o:p></o:p></span></p>
      </td>
     </tr>
     <tr style=3D'mso-yfti-irow:1'>
      <td width=3D176 valign=3Dtop style=3D'width:148.05pt;padding:0cm 5.4pt 0cm 5.4pt;'>
      <p class=3DMsoNormal><o:p>Renglon: ".$resultado_maquinas->fields["codigo_renglon"]."<br><b>".$_GET['titulo_etiqueta']."</b></o:p></p>
      </td>
     </tr>
	 <tr style=3D'mso-yfti-irow:3'>
      <td width=3D235 valign=3Dtop style=3D'width:148.05pt;padding:0cm 5.4pt 0cm 5.4pt'>
      <p class=3DMsoNormal><b style=3D'mso-bidi-font-weight:normal'><span lang=3DEN-US style=3D'font-size:
      8.0pt;mso-ansi-language:EN-US;mso-fareast-language:ES-AR'>".$_GET['descripcion_etiqueta']."</span></b><span
     ...
     /*<tr style=3D'mso-yfti-irow:5'>
      ...
      lang=3DES-AR style=3D'font-size:8.0pt;mso-ansi-language:ES-AR;mso-fareast-language:
      ES-AR'>0810-22-2672347 (CORADIR)</span><span lang=3DES-AR style=3D'font-size:8.0pt;
      mso-ansi-language:ES-AR;mso-fareast-language:ES-AR'><o:p></o:p></span></p>
	  <p class=3DMsoNormal><span
      class=3DSpellE><span lang=3DES-AR style=3D'font-size:8.0pt;mso-ansi-language:
      ES-AR;mso-fareast-language:ES-AR'>serviciotecnico@coradir.com.ar</span></span><span
      lang=3DES-AR style=3D'font-size:8.0pt;mso-ansi-language:ES-AR;mso-fareast-language:
      ES-AR'></span></p>
      </td>
	 </tr>*/
     ."<tr style=3D'mso-yfti-irow:6;mso-yfti-lastrow:yes'>
      <td width=3D235 valign=3Dtop style=3D'width:148.05pt;padding:0cm 5.4pt 0cm 5.4pt'>
      <p class=3DMsoNormal><span
      lang=3DES-AR style=3D'font-size:10.0pt;mso-ansi-language:ES-AR;mso-fareast-language:
      ES-AR'>Industria Argentina&nbsp;&nbsp;-&nbsp;&nbsp;ID: ".$resultado_maquinas->fields["id_licitacion"]."<o:p></o:p></span></p>
      </td>
     </tr>
	 <tr style=3D'mso-yfti-irow:5'>
      ...
      lang=3DES-AR style=3D'mso-ansi-language:ES-AR;mso-fareast-language:ES-AR'><!--[if gte vml 1]><v:shape
       id=3D\"_x0000_i1031\" type=3D\"#_x0000_t75\" style=3D'width:131.9pt;height:25.75pt'>
       <v:imagedata src=3D\"word2003-mejorULTIMA_archivos/$serie_armado.png\" o:title=3D\"CDR%20Computers%20black\"/>
      </v:shape><![endif]--><![if !vml]><img style=3D'width:131.9pt;height:25.75pt'
      src=3D\"word2003-mejorULTIMA_archivos/$serie_armado.png\" v:shapes=3D\"_x0000_i1031\"><![endif]></span></p>
      </td>
     </tr>
    </table>
    </div>
  ...
  <td width=3D227 valign=3Dtop style=3D'width:.6cm;padding:0cm 0cm 0cm 0cm'>
  <p class=3DMsoNormal><o:p></o:p></p>
  </td>";
if ($columna==3) {
 $buffer.="</tr>";
}
if(($fila==3) && ($columna==3)) { //inserto salto de pagina
 $buffer.="
</table>
...
//actualizo el nro de serie de la maquina siguiente
$nro++;
if ($nro==1000) {
	$nro=000;
	if (trim(chr(ord($letra3)+1)) > 'Z') {
...
//$resultado_maquinas->MoveNext();
$cantidad_impresa++;
$cant_total++;
}


//lleno las celdas libres
while(((($fila*3)-(3-$columna))<=9) && !($fila==1 && $columna==1))
{
if ($columna==1)
 $buffer.='<tr style=3D\'mso-yfti-irow:1;mso-yfti-lastrow:yes;page-break-inside:avoid\'>';
$buffer.="<td width=3D227 valign=3Dtop style=3D'width:6.0cm;padding:0cm 0cm 0cm 0cm'>
          <p class=3DMsoNormal><b><span lang=3DES-AR style=3D'font-size:10.0pt;mso-ansi-language:
          ES-AR;mso-fareast-language:ES-AR'><o:p>&nbsp;</o:p></span></b></p>
          </td>
		  <td width=3D227 valign=3Dtop style=3D'width:.6cm;padding:0cm 0cm 0cm 0cm'>
		  <p class=3DMsoNormal><o:p></o:p></p>
		  </td>";
...
case 3:$columna=1;
       $fila++;
       if ($fila==4)
        $fila=10; //para que salga del while
       break;
}
