...
$ubicacion=$parametros['ubicacion'] or $ubicacion=$_POST['ubicacion'] or $ubicacion='Buenos Aires';
...
$datos=array("San Luis","Buenos Aires","Todas");
...
$sql="select id_asistencia,fecha,tipo,comentario,hora_entra,id_usuario,usuario from 
      (select id_usuario,usuarios.apellido || ' ' || usuarios.nombre as usuario from sistema.usuarios
       left join licitaciones.distrito on distrito.id_distrito=usuarios.pcia_ubicacion 
