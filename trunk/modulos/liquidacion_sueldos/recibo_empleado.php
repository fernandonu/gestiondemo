...
<table width="100%"  border="1" bordercolor="#000000">
 ...
 <table width="74%"  border="0" align="center">
   <tr>
    <td><strong>Original para el Empleado</strong></td>
   </tr>
   <tr>
   ...
   <tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0" class="estilo1">
     ...
     <tr>
      ...
      <?/*<input name="nombre_apell" type="text" class=text_6 readonly="true" value="<?=$apellido." ".$nombre;?>"> */
       ?>
      </td>
...
<? if ($anticipo!=0){?>
	...
	<table width="100%"  bordercolor="#000000">
       <tr><td colspan="6">&nbsp;</td></tr>
	   <tr>
        <td width="20%" class="estilo1" align="center"><strong>Firma Empleador</strong></td>
        <td width="14%">&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="3">&nbsp;</td>
        <td class="estilo1" align="center"><strong>Total Neto</strong></td>
