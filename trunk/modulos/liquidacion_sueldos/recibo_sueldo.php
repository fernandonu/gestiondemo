...
$lugar_trabajo=$result->fields["ubicacion"]; 
...
if ($lugar_trabajo==2){
    ...
    $direccion_sucursal=" Patagones 2538 - Parque Patricios";

    $direccion_pago="Patagones 2538";

    $provincia_sucursal=" Capital Federal";

}

else{

    $direccion_sucursal=" San Martin 450";

    $direccion_pago="San Martin 450";

    $provincia_sucursal=" San Luis";
    ...
    <td> <!-- tabla para datos 1 -->
     ...
     <table width="100%" class="estilo1" cellpadding="0" cellspacing="0">
      ...
      <? list($año_pago, $mes_pago, $dia_pago)=split('[-]', $fecha);
       ...
       <td class="estilo2" align="center"><input name="dom_pago" type="text" size="30" class=text_6 readonly=true value="<?=$direccion_pago?>"></td>
...
?>     
     ...
     <tr bordercolor="#FFFFFF">
      ...
      <td align="left" class="estilo2">&nbspHoras</td>

      <td class="estilo2" align="right"><?=$horas?></td>

      <td class="estilo2" align="right"><?=setea_datos($valor_hora)?></td>

      <td class="estilo2" align="right" ><?=setea_datos($horas*$valor_hora);?></td>
    ...
    ?>
     ...
     <tr bordercolor="#FFFFFF">
      ...
      <td align="left" class="estilo2">&nbspHoras Extras</td>

      <td class="estilo2" align="right"><?=$horas_extras?></td>

      <td class="estilo2" align="right"><?=setea_datos($valor_hora*$tipo_hora_extras)?></td>

      <td class="estilo2" align="right"><?=setea_datos($horas_extras*$valor_hora*$tipo_hora_extras);?></td>
...
?>    
    ...
    <tr bordercolor="#FFFFFF">
      ...
      <td align="left" class="estilo2">&nbsp;Horas Extras</td>

      <td class="estilo2" align="right"><?=$horas_extras?></td>

      <td class="estilo2" align="right"><?=setea_datos($arreglo['valor_horas_extras']);?></td>

      <td class="estilo2" align="right"><?=setea_datos($arreglo['subtotal_horas']);?></td>
...
?>
    ...
    <tr bordercolor="#FFFFFF">
      ...
      <td align="left" class="estilo2">&nbsp;Embargos</td>
      ...
      <td class="estilo2" align="right"><?=setea_datos($embargo);?></td>
...
<? if ($pre_aviso!=0){?>
 ...
 if ($acuerdo_abril_2006!=0){?>

    <tr bordercolor="#FFFFFF">

      <td align="left" class="estilo2">&nbsp;Acuerdo Abril 2006</td>
      ...
      <td align="right"><?=setea_datos($acuerdo_abril_2006);?></td>
...
<? if ($anticipo!=0){?>
    ...
    <table width="100%"  bordercolor="#000000">
       ...
       <tr>
        ...
        <td width="20%" class="estilo1" align="center"><strong><?=$firma?></strong></td>
        ...
        <td width="16%" class="estilo1" align="right"><?=setea_datos($arreglo['total_no_rem'],".",2,0);?></td>
