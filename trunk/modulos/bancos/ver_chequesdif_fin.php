...
variables_form_busqueda("chequesdif_fin",array("id_banco" => "",
										   "Entre_Fechas" => "",
										   "Entre_Fechas_Campo" => "",
										   "Entre_Fechas_Desde" => "",
										   "Entre_Fechas_Hasta" => ""));
...
<br>
<font size="4"><b>Cheques Diferidos Finalizados</b></font>
<hr>
<?
echo "<form action=ver_chequesdif_fin.php method=post>\n";
...
//Total
$sql = "SELECT sum(monto) AS total FROM cheques_diferidos WHERE IdDepósito IS NOT NULL or id_ingreso_egreso IS NOT NULL";
...
echo "</select></td>\n";
echo "<td colspan=3 align=center><b>Total Finalizado: \$ $Total</b>";
echo "</td></tr>";
...
$where_tmp = "(cheques_diferidos.IdDepósito IS NOT NULL or cheques_diferidos.id_ingreso_egreso IS NOT NULL) ";
if ($Banco!="todos")
...
echo "<td align=center width=70%>Cheques Finalizados: $total_pend</td>\n";
echo "<td align=center width=30%>$link_pagina&nbsp;</td>\n";
echo "</tr></table>\n";
echo "</td></tr>\n";
echo "<tr  id=mo>";//bordercolor='#000000'
echo "<td align=center>&nbsp;</td>";
echo "<td align=center><a id=mo href='".encode_link('ver_chequesdif_fin.php',Array('sort'=>1,'up'=>$up))."'>Vencimiento</a></td>\n";
echo "<td align=center><a id=mo href='".encode_link('ver_chequesdif_fin.php',Array('sort'=>2,'up'=>$up))."'>Emisión</a></td>\n";
echo "<td align=center><a id=mo href='".encode_link('ver_chequesdif_fin.php',Array('sort'=>3,'up'=>$up))."'>Número</a></td>";
echo "<td align=center><a id=mo href='".encode_link('ver_chequesdif_fin.php',Array('sort'=>4,'up'=>$up))."'>Importe</a></td>";
echo "<td align=center><a id=mo href='".encode_link('ver_chequesdif_fin.php',Array('sort'=>7,'up'=>$up))."'>Pertenece</a></td>";
echo "<td align=center><a id=mo href='".encode_link('ver_chequesdif_fin.php',Array('sort'=>8,'up'=>$up))."'>Entidad</a></td>";
echo "<td align=center><a id=mo href='".encode_link('ver_chequesdif_fin.php',Array('sort'=>5,'up'=>$up))."'>Comentarios</a></td>";
echo "<td align=center><a id=mo href='".encode_link('ver_chequesdif_fin.php',Array('sort'=>6,'up'=>$up))."'>Ubicacion</a></td>";
...
echo "<tr bgcolor=$bgcolor3><td colspan=9 align=center><b>Subtotal Finalizado: \$ ".formato_money($SubTotal)."</b></td></tr>";
echo "</table></form>\n";
?>