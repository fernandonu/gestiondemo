...
{global $nro_orden,$id_licitacion;
    ...
    $this->setxy(15,10);
	$this->Cell(80,10,"Orden de Compra");
	$this->setxy(15,13);
	$this->cell(80,20,"Nro : ");
	/*Para licitacion*/
...
//	$this->cell(30,8,"Internet  Service  Provider");
	if($this->PageNo()!=1)
	{
	 $this->setxy(5,45);
	 $this->SetFontSize(11);
	 $this->cell(0,0,"Orden de Compra Nº ".$nro_orden." - Continuación",0,0,'C');
...
function dibujar_planilla($flag_fecha_cta_corriente=false) {
...
//	$this->cell(30,6,'Nº Orden de Compra ');
	...
	if ($flag_fecha_cta_corriente){
		$this->setxy(88,$this->recuperar_base1()+2);
		$this->cell(30,6,'Cta. corriente, Fecha de facturación ');
	}
	...
	$this->cell(200,5,'Por la presente cumplo  dirigirme a  Usted solicitando  la  provisión de los  productos que  detallo a ');
	...
	$this->cell(200,5,'continuación. Solicito me responda por este mismo medio la conformidad de la misma.');
 	$this->setxy(7,$this->recuperar_base1()+38);
	$this->cell(200,5,'No se recibirá la mercaderia si no esta acompañada por su correspondiente factura y copia impresa de');	
	$this->setxy(7,$this->recuperar_base1()+43);
	$this->cell(200,5,'esta Orden de Compra. Por favor llevar recibo de Pago. Gracias.');	
	//$this->setxy(7,$this->recuperar_base1()+48);
	//$this->cell(200,5,' ');	
	$this->SetFont('Arial','B',14);
	...
	$this->cell(35,5,'Cliente: ');
	//$this->Rect(5,$this->recuperar_base1()+104,200,35);
	//$this->Rect(5,$this->recuperar_base1()+145,200,6);
...
{global $nro_orden;
 //ir a 1.2 cm del final de la hoja
    ...
    $this->Cell(0,10,'Orden de Compra Nº '.$nro_orden.' - Página '.$this->PageNo().'/total_pag',0,0,'C');
