...
$sql.=" where estado='e'  and proveedor.id_proveedor=$id_proveedor";
...
/* (ESTO ES NECESARIO PORQUE JAVASCRIPT NO TOMA NOMBRES DEL ESTILO chk_orden[], ENTONCES NO
    ...
    Y A SU VEZ, ENVIA UN ARREGLO CON LAS ORDENES SELECIONADAS A LA PAGINA ord_pagos.php)*/
if($_POST['boton']=="Agregar Ordenes")
{
 $link=encode_link("ord_pagos.php",array("pagina_viene"=>"pago_multiple","armando"=>"si"));
...
<tr>
  ...
  Listado de las Ordenes de Compra
  </td>
</tr>
<tr>
  <td width="1%">
 ...
 echo "<tr bgcolor='#c0c6c9'>";
  echo "<td>";
   ...
   echo "  onclick='
                    ...
                    { this.checked=0;
                      alert(\"No se puede incluir en un pago múltiple, ordenes de compra con monedas distintas\");
                    }'";
   echo "  >";
  ...
  echo "</td>";
  echo "<td>";
    echo  "<font color='#006699'><b>$cliente </font>";
  echo "</td>";
  echo "<td>";
...
<tr>
 <td colspan='5' align='center'>
  <?
  $link=encode_link("./ord_compra_pagar.php",array("nro_orden"=>$nro_orden));
  ?>
