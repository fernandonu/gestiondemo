...
<form name="form1" method="post" action="listado_clientes.php">
<center>
 ...
 <td width="109">
        ...
        <td width="149" >
          <div align="center">
            <input type="submit" name="bconsulta" value="Ver Datos" title="Presione aqui para realizar la busqueda">
          </div>
        </td>
      </tr>
    </table>
...
//$query="select * from general.clientes, general.factura where cliente.id_cliente=factura.id_cliente";

$query="SELECT * FROM general.clientes";
...
while (!$resultado->EOF)
{
  ...
  $atrib.=" title='Presione aqui para ver mas detalles' style=cursor:hand";
