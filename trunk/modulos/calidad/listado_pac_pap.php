...
&nbsp;&nbsp;<img src='<?php echo "$html_root/imagenes/ayuda.gif" ?>' border="0" alt="ayuda" onClick="abrir_ventana('<?php echo "$html_root/modulos/ayuda/calidad/ayuda_pac_pap.htm" ?>', 'LISTADO PAC_PAP')" >
</center>
<?=$msg;?>
