...
if($id_manual){
     ...
     if(!permisos_check("inicio","permiso_hitorial_manual"))
      $disabled_historial="disabled";

     if(!permisos_check("inicio","permiso_revisado_manual"))
      $disabled_revisado="disabled";

     if(permisos_check("inicio","permiso_validado_manual"))
        $disabled_validado="";
        else
        $disabled_validado=" disabled";
